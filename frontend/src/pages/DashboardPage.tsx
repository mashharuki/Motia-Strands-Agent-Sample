            ...
            <div className="donut-container">
              ...
              <div className="donut-legend">
                <div className="legend-item">
                  ...
                  <span className="legend-count">{priorityCounts.low}</span>
                </div>
                <div className="legend-item">
                  <div
                    className="legend-dot"
                  ...
                  <span className="legend-count">{priorityCounts.medium}</span>
                </div>
                <div className="legend-item">
                  <div
                    className="legend-dot"
                  ...
                  <span className="legend-count">{priorityCounts.high}</span>
                </div>
                <div className="legend-item">
                  <div
                    className="legend-dot"
