          ...
          <div className="detail-card">
            <div className="detail-header">
              ...
              <div className="detail-id-row">
                ...
                <span
                  className={`status-badge badge-${statusClass(ticket.status)}`}
                >
                ...
                {ticket.escalation && (
                  <div className="timeline-item">
                    <div
                      ...
                      style={{ background: "var(--status-escalated)" }}
                    />
                    <span className="timeline-actor">System</span>
                    <span className="timeline-action">
                      {" "}
                      &mdash; escalated: {ticket.escalation.reason}
                    </span>
                    <div className="timeline-time">
                      {formatRelativeTime(ticket.escalation.escalatedAt)}
                    </div>
                  </div>
                )}
                {ticket.triageResult && (
                  <div className="timeline-item">
                    ...
                    <span className="timeline-action">
                      {" "}
                      &mdash; assigned to {ticket.triageResult.assignee},
                      priority set to {ticket.triageResult.priority}
                    </span>
                    <div className="timeline-time">
