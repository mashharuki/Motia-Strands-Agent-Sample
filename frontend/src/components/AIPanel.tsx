...
export function AIPanel({ open, onClose, contextTicketId }: AIPanelProps) {
  const [messages, setMessages] = useState<Message[]>([
    { id: ++msgId, role: "time", content: "Today" },
    {
      ...
      role: "ai",
      content:
        "Hello! I'm your AI support assistant powered by Strands Agent. I can help you analyze tickets, suggest triage actions, and assess SLA risks. What would you like to know?",
    },
  ]);
      ...
      <div className={`ai-panel ${open ? "open" : ""}`}>
        ...
        <div className="ai-messages" ref={messagesRef}>
          {messages.map((msg) => {
            if (msg.role === "time") {
              return (
                <div key={msg.id} className="msg-time">
                  {msg.content}
                </div>
              );
            }
...
function formatAIMessage(text: unknown): string {
